...
export default function DriverSignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="py-12 px-4 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-4 bg-white/20 text-white hover:bg-white/30">Join Our Team</Badge>
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Become a Driver</h1>
          <p className="text-xl opacity-90 max-w-3xl mx-auto">
            Start earning with Gogo.lk! Join thousands of drivers who trust us for flexible work and reliable income.
          </p>
        </div>
      </section>
      ...
      <section className="py-6 px-4 bg-white border-b">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold">Driver Application</h2>
          ...
          {currentStep === 1 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Please provide your personal details for verification and account setup.
                </CardDescription>
              </CardHeader>
          ...
          {currentStep === 2 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Provide details about your vehicle and upload a clear photo.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => setFormData((prev) => ({ ...prev, vehicleCapacity: value }))}>
                      <SelectTrigger>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-gray-600">
                        Upload a clear photo of your vehicle (front view preferred)
                      </p>
                      ...
                      <Input
                        ...
                        accept="image/*"
                        className="hidden"
                        onChange={(e) => handleFileUpload("vehicleImage", e.target.files?.[0] || null)}
                      />
                      <Button
                        type="button"
                        variant="outline"
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-800 mb-2">Vehicle Requirements:</h4>
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>• Vehicle must be in good working condition</li>
                    <li>• Valid registration and insurance required</li>
                    <li>• Vehicle age should not exceed 15 years</li>
                    <li>• Clean interior and exterior</li>
                    <li>• Working air conditioning (for cars)</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-sm space-y-1">
                      <p>
                        <span className="font-medium">Type:</span> {formData.vehicleType}
                      </p>
                      <p>
                        <span className="font-medium">Make/Model:</span> {formData.vehicleMake} {formData.vehicleModel}
                      </p>
                      <p>
                        <span className="font-medium">Year:</span> {formData.vehicleYear}
                      </p>
                      <p>
                        <span className="font-medium">License Plate:</span> {formData.licensePlate}
                      </p>
                      <p>
                        <span className="font-medium">Capacity:</span> {formData.vehicleCapacity}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          setFormData((prev) => ({ ...prev, agreeInsurance: checked as boolean }))
                        }
                        required
                      />
                      <Label htmlFor="agreeInsurance" className="text-sm leading-relaxed">
                        I confirm that my vehicle has valid insurance and I will maintain it throughout my partnership
                        with Gogo.lk
                      </Label>
                    </div>
                  </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-green-700 space-y-1">
                    ...
                    <li>• Background and document verification will be conducted</li>
          ...
          <div className="flex justify-between mt-8">
            ...
            {currentStep < totalSteps ? (
              ...
              <Button
                ...
                disabled={!formData.agreeTerms || !formData.agreeBackground || !formData.agreeInsurance}
              >
                Submit Application
              </Button>
            )}
